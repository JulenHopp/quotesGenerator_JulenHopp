...
document.querySelector(".generate-quote-button")
    .addEventListener('click', () =>{quoteChange()});
...
function quoteChange(){
    ...
    document.querySelector(".js-quote-text")
        .textContent = randomValue;
    
    document.querySelector(".js-quote-author")
